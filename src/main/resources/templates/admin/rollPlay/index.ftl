...
<style>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            //初始化表格,动态从服务器加载数据
            $("#table_rollPlay_list").bootstrapTable({
                //使用get请求到服务器获取数据
                method: "GET",
                ...
                onClickRow:function (row) {
                    ...
                    $("#table_rollPlay_list").bootstrapTable('refresh', opt);
                }
            });
            var setting = {
                data: {
            ...
            $.get("/admin/rollPlay/tree",function(data){
        ...
        function del(id){
            layer.confirm('确定删除吗?', {icon: 3, title:'提示'}, function(index){
                $.ajax({
                    type: "DELETE",
                    dataType: "json",
                    url: "${ctx!}/admin/rollPlay/delete/" + id,
                        ...
                        <div class="row row-lg">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="example-wrap">
                                    <div class="example">
                                        <table class="table table-bordered"  id="table_rollPlay_list"></table>
                                    </div>
                                </div>
