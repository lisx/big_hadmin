...
<#include "/admin/common/ztree.ftl">
    <script type="text/javascript">
        $(document).ready(function () {
            //初始化表格,动态从服务器加载数据
            $("#table_rules_list").bootstrapTable({
                //使用get请求到服务器获取数据
                method: "GET",
                ...
                onClickRow:function (row) {
                    ...
                    $("#table_rules_list").bootstrapTable('refresh', opt);
                }
            });
            var setting = {
                data: {
        ...
        function showFolder(folder){
            layer.open({
                ...
                shade: false,
                area: ['100%', '100%'],
                content: '${ctx!}/admin/rules/toFolder?folder='+folder,
                end: function(index){
                    $('#table_rules_list').bootstrapTable("refresh");
                }
            });
        };
        //上传资料文件
        function uploadFile(){
            ...
            layer.open({
                ...
                shade: false,
                area: ['100%', '100%'],
                content: '${ctx!}/admin/rules/uploadFile?nodeCode='+id,
                end: function(index){
                    $('#table_rules_list').bootstrapTable("refresh");
                }
            });
        ...
        function addFolder(){
            ...
            layer.open({
                ...
                shade: false,
                area: ['400px', '400px'],
                content: '${ctx!}/admin/rules/add?nodeCode='+nodeCode+'&menu=应急预案',
                end: function(index){
                    $('#table_rules_list').bootstrapTable("refresh");
                }
            });
                        ...
                        <div class="row row-lg">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="example-wrap">
                                    <div class="example">
                                        <table id="table_rules_list"></table>
                                    </div>
                                </div>
