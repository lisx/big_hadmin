...
<script type="text/javascript">
    ...
    function onClick(e, treeId, treeNode) {
        ...
        var opt = {
            url: "${ctx!}/admin/emergency/list?menuType=规章制度",
            silent: true,
            query: {
    ...
    function showFolder(folderId) {
        button.showFolder('${ctx!}/admin/rules/toFolder?folderId=' + folderId+'&menuType=规章制度')
    };
    //上传资料文件
    function uploadFile() {
        button.uploadFile('${ctx!}/admin/emergency/uploadFile?menuType=规章制度')
    };
    //添加文件夹
    function addFolder() {
        button.addFolder('${ctx!}/admin/emergency/add?menuType=规章制度')
    }
    //下载文件
